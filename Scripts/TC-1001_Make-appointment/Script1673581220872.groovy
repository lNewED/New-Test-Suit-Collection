...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Visit Date (Required)_visit_date'), '13')

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/td_13'))

WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'บิ๊กตู่จ้องจะเล่นคุณอยู่!!')

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/button_Book Appointment'))

WebUI.verifyTextPresent('บิ๊กตู่จ้องจะเล่นคุณอยู่!!', false)
