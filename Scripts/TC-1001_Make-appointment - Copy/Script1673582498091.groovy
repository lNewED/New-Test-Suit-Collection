...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Visit Date (Required)_visit_date'), '13000000000')

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/td_13'))

WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'เหล่าสภาของตู่จ้องจะเล่นคุณอยู่!!')
